...
// Changing the time variables form string to numeric //
	...
	label var time_diff "Time difference (Start and End)”
	

// Renaming and recoding variables for ease of analysis of the MAPS Survey //
...
//Shops Subscale
	gen Shops = LU6d + LU6e + LU6h + LU6g + LU6i  + LU6n
...
//Destinations and Land Use: Positive subscale
...
//Positive Buildings Height and Setbacks Subscale
	...
	label var PosBldgHtSetbks "Positive Setbacks/Bldg. Height: Positive subscale"
...
//Curb Quality/Presence
	...
	label var C1_5b_positive "Pre-crossing curb- Ramp lines up with crossing"
...
//Positive Crossing Subscale
	...
	label var PosCrossChars_C1 "Positive Crossing"
